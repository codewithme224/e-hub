<template><footer class="w-full mt-5 border border-gray-200 rounded shadow-lg dark:border-gray-700">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="grid max-w-sm grid-cols-2 gap-3 py-10 mx-auto sm:grid-cols-4 lg:grid-cols-6 gap-y-8 md:gap-8 sm:max-w-3xl lg:max-w-full">
            ...
            <div class="text-left lg:mx-auto ">
                <h4 class="text-lg font-medium text-gray-900 mb-7">Pagedone</h4>
                <ul class="text-sm transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-100">Home</a></li>
                    <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-100">About</a></li>
                    <li><a href="javascript:;"  class="text-gray-600 hover:text-gray-100">Pricing</a></li>
                </ul>
            </div>
            <!--End Col-->
            ...
            <div class="text-left lg:mx-auto ">
                ...
                <p class="text-sm leading-6 text-gray-500 mb-7">Subscribe to get the latest news from us</p>
                <a href="javascript:;"  class="flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-indigo-600 transition-all duration-500 border border-indigo-600 rounded-full w-fit lg:mx-0 hover:bg-indigo-50">Subscribe<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
